...
<meta charset="utf-8">
  ...
  <title>Active Sports House Ordering System : Order Details</title>
  <!-- Bootstrap -->
    ...
    try {
      ...
      $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $stmt = $conn->prepare("SELECT * FROM tbl_orders_a175308_pt2, tbl_staffs_a175308_pt2,
          tbl_customers_a175308_pt2 WHERE
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      <div class="form-group">
        ...
        <button class="btn btn-default" type="submit" name="addproduct" id="btn_create"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add Product</button>
